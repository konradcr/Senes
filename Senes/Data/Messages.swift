...
extension Chat {
    ...
    static let sampleChat = [
        ...
        Chat(person: Personne(name: "Jeanine", profilPic: "Jeanine"), messages: [
        ...
        Chat(person: Personne(name: "PapiFun", profilPic: "Papifun"), messages: [
        ...
        Chat(person: Personne(name: "Stephanie", profilPic: "Stephanie"), messages: [
            Message("Bonjour Jean 😚", type: .Sent, date: Date(timeIntervalSinceNow: -86400 * 3)),
            Message("Qu'as-tu pensé de ton séjour à Lima ?", type: .Sent, date: Date(timeIntervalSinceNow: -86400 * 3)),
            Message("Comme je m'y attendais, génial, c'est vraiment une destination à ne pas rater.", type: .Received, date: Date(timeIntervalSinceNow: -86400 * 7)),
            Message("Ok ce sera probablement ma prochaine destination 😄", type: .Sent, date: Date(timeIntervalSinceNow: -86400 * 6)),
            Message("Super, tiens-moi au courant de ton voyage et amuse-toi bien!!!", type: .Received),
        ], hasUnreadMessage: true),
        
        Chat(person: Personne(name: "Pascal", profilPic: "Pascal"), messages: [
        ...
        Chat(person: Personne(name: "Vanessa", profilPic: "Vanessa"), messages: [
